...
def create_window(width=800, height=600, bg_color=(240, 240, 240, 255), caption="minestomper"):
    """
    ...
    :param tuple bg_color: background color, tuple containing four values
                           (0-255, RGBA)
    :param str caption: window caption
    """

    if graphics["window"] is None:
        # NOTE: Added support for window caption
        graphics["window"] = pyglet.window.Window(width, height, resizable=True, caption=caption)
